...
*/
        ...
        .prato {
            width: calc(50% - 10px);
            /* Para deixar espaço entre os pratos */
    ...
    <main>
        ...
        <section>
            ...
            <div class="avaliacoes">
                ...
                <div class="avaliacao">
                    <p>
                        <i class="bi bi-star-fill" style="color: #fd4;"></i>
                        <i class="bi bi-star-fill" style="color: #fd4;"></i>
                        <i class="bi bi-star-fill" style="color: #fd4;"></i>
                        <i class="bi bi-star-fill" style="color: #fd4;"></i>
                        <i class="bi bi-star-fill" style="color: #fd4;"></i>
                ...
                <div class="avaliacao">
                    ...
                    <p class="comentario">"Não fez mais que a obrigação."</p>
                    <p class="autor">- José Samuel</p>
                </div>
            </div>
            <div class="informacoes-contato">
                <h3>Informações de Contato</h3>
                <p>Telefone: +55 (83) 98195-8797</p>
                <p>E-mail: contato@fynderfoodie.com</p>
                <p>Horário de Atendimento: Seg-Sex, 9h-18h; Sab-Dom, 12h-18h</p>
